...
class MockServiceReservationDetailsApiImp extends Mock
    implements ServiceReservationDetailsApiImp {}

void main() {
  late MockServiceReservationDetailsApiImp? mockServiceReservationDetailsApiImp;
  late UserUpcomingOneTimeServiceDetailsRepositoryImp?
      userUpcomingOneTimeServiceDetailsRepositoryImp;

  setUp(() {
    mockServiceReservationDetailsApiImp = MockServiceReservationDetailsApiImp();
    userUpcomingOneTimeServiceDetailsRepositoryImp =
        UserUpcomingOneTimeServiceDetailsRepositoryImp(
  ...
  test(
    ...
    () async {
      ...
      // Act
      final result = await userUpcomingOneTimeServiceDetailsRepositoryImp!
