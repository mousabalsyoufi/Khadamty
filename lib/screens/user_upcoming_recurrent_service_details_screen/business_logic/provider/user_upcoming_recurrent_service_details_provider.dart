...
import '../../domain/usecase/get_upcoming_recurrent_service_details_usecase.dart';

class UserUpcomingRecurrentServiceDetailsProvider extends BaseProvider {
  final GetUpcomingRecurrentServiceDetailsUseCase
      _getUpcomingServiceDetailsUseCase;
