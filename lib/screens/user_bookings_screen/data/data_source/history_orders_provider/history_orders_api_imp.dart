...
import 'package:faciltateur_de_vies/screens/user_bookings_screen/data/data_source/history_orders_provider/history_orders_api.dart';
...
// GET orders history api call implementation
class HistoryOrdersApiImp extends BaseApiProvider implements HistoryOrdersApi {
  @override
  Future<ApiResponse<List<HistoryOrdersModel>?>> historyOrders({int? page, int? limit, DateTime? date}) async {
    ...
    try {
      ...
      var list  = response.data[ApiKeys.data][ApiKeys.result].map<HistoryOrdersModel>((json) => HistoryOrdersModel.fromJson(json)).toList();
