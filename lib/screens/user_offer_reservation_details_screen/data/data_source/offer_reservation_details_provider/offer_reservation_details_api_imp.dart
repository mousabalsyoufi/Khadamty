...
import 'offer_reservation_details_api.dart';

// Offer Reservation Details api call implementation
class OfferReservationDetailsApiImp extends BaseApiProvider
    implements OfferReserationDetailsApi {
  @override
  Future<ApiResponse<ServiceReservationDetailsModel>>
      getOfferReservationDetails({required String id}) async {
