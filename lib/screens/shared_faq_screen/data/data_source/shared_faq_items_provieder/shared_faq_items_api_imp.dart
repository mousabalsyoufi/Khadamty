...
import 'package:faciltateur_de_vies/screens/shared_faq_screen/data/data_source/shared_faq_items_provieder/shared_faq_items_api.dart';
...
// shared faq items api call implementation
class SharedFaqItemsApiImp extends BaseApiProvider
    implements SharedFaqItemsApi {
  @override
  Future<ApiResponse<List<SharedFaqModel>>> getSharedFaqItems(
