...
import 'package:faciltateur_de_vies/screens/shared_faq_screen/data/data_source/shared_faqs_provider/shared_faqs_api.dart';
...
// shared faqs api call implementation
class SharedFaqsApiImp extends BaseApiProvider implements SharedFaqsApi {
  @override
  Future<ApiResponse<List<SharedFaqModel>>> getSharedFaqs() async {
