...
class ServiceDateDayPickerReschedule extends StatefulWidget {
  const ServiceDateDayPickerReschedule({super.key});

  @override
  State<ServiceDateDayPickerReschedule> createState() =>
      _ServiceDateDayPickerRescheduleState();
}

class _ServiceDateDayPickerRescheduleState<T>
    extends State<ServiceDateDayPickerReschedule> {
  final DateTime _focusedDay = DateTime.now();

  @override
  Widget build(BuildContext context) {
    return Selector<UserUpcomingRescheduleProvider, DateTime?>(
        selector:
            (BuildContext context, UserUpcomingRescheduleProvider provider) =>
          ...
          return TableCalendar(
            ...
            onDaySelected: (selectedDay, focusedDay) {
              if (!isSameDay(oneTimeSelectedDay, selectedDay)) {
                Provider.of<UserUpcomingRescheduleProvider>(context,
                        listen: false)
